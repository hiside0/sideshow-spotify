<template>
    <v-app>
    <v-container fluid>
    <p class="text-h6">Spotify APIで得られる楽曲の特徴データ(audio_features)から、<u>ウマ娘とミリオンライブの</u>似た曲を見つけるやつ</p>
    <v-spacer class="mb-4" />
    <span>指標値:</span> 
    <v-spacer class="mb-2" />
    ...
    <v-dialog v-model="dialog_click" max-width="400">
        ...
        <v-card-actions class="ml-2">
            ...
            <v-btn small color="primary" @mousedown="setNeighborParam(); closeClickDialog();">Change</v-btn>
        </v-card-actions>
        </v-card>
    </v-dialog>
    </v-container>
